...
We do not use github issues for general library support. We think this questions should be posted on stack overflow using [Xniffer](http://http://stackoverflow.com/questions/tagged/xniffer) tag.

### Reporting issues

* Use [github issues](https://github.com/xmartlabs/Xniffer/issues) to report a bug.
* Before creating a new issue:
  * Make sure you are using the [latest release](https://github.com/xmartlabs/Xniffer/releases).
  * Check if the issue was [already reported or fixed](https://github.com/xmartlabs/Xniffer/issues?utf8=%E2%9C%93&q=is%3Aissue). Notice that it may not be released yet.
...
2. Clone your forked project into your developer machine: `git clone git@github.com:<your-github-username>/Xniffer.git`
3. Add the original project repo as upstream repository in your forked project: `git remote add upstream git@github.com:xmartlabs/Xniffer.git`
...
* We use `type: feature request` label to mark all [feature request issues](https://github.com/xmartlabs/Xniffer/labels/type%3A%20feature%20request).
